...
def list_ugen_cmds(sd):
    ...
    for ugen in sd._children:
        ...
        if ugen.inputs is not None:
            inputs = [
                x._dump_name() if isinstance(x, SynthObject) else x for x in ugen.inputs
            ]
...
class SpIndexTestCase(unittest.TestCase):
    ...
    def test_unary(self):
        params = [
            ...
            ("sqrt", "1_sqrt"),
            ("exp", "1_exp"),
            ("reciprocal", "1_reciprocal"),
            ("midicps", "1_midicps"),
            ("cpsmidi", "1_cpsmidi"),
            ("midiratio", "1_midiratio"),
            ("ratiomidi", "1_ratiomidi"),
            ("dbamp", "1_dbamp"),
            ("ampdb", "1_ampdb"),
            ("octcps", "1_octcps"),
            ("cpsoct", "1_cpsoct"),
            ...
            ("rand2", "1_rand2"),
            ("linrand", "1_linrand"),
            ("bilinrand", "1_bilinrand"),
            ("sum3rand", "1_sum3rand"),
            ("distort", "1_distort"),
            ("softclip", "1_softclip"),
            ("coin", "1_coin"),
            ("rectwindow", "1_rectWindow"),
            ("hanwindow", "1_hanWindow"),
            ("welwindow", "1_welWindow"),
            ("triwindow", "1_triWindow"),
            ("ramp", "1_ramp"),
            ("scurve", "1_scurve"),
        ]
    ...
    def test_binary(self):
        params = [
            ...
            (
                "urshift",
                "1_unsignedRightShift",
            ),  # ('fill', '1_fill'),  # TODO: Unused in sclang.
            ("ring1", "1_ring1"),
            ("ring2", "1_ring2"),
            ("ring3", "1_ring3"),
            ("ring4", "1_ring4"),
        ...
        for name1, name2 in params:
            ...
            def test():
                sig = Saw()
                Out.ar(0, getattr(sig, name1)(sig))
